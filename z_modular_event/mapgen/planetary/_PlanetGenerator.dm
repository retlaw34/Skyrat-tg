...
/datum/advanced_map_generator/planet_generator
...
/datum/advanced_map_generator/planet_generator/New(...)
...
/datum/advanced_map_generator/planet_generator/generate_turf(turf/gen_turf, changeturf_flags)
	var/area/A = get_area(gen_turf)
	if(!(A.area_flags & CAVES_ALLOWED))
		return

	var/datum/adv_biome/turf_biome = get_biome(gen_turf)

	// using istype() here suuuuucks, i'm sorry.
	var/area/used_area = istype(turf_biome, /datum/adv_biome/cave) ? cave_area : primary_area
	turf_biome.generate_turf(gen_turf, used_area, changeturf_flags, string_gen)

/datum/advanced_map_generator/planet_generator/populate_turfs()
...
/datum/advanced_map_generator/planet_generator/populate_turf(turf/gen_turf)
...
/datum/advanced_map_generator/planet_generator/proc/get_biome(turf/a_turf)
