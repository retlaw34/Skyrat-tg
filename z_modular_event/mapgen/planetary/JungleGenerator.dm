/datum/advanced_map_generator/planet_generator/jungle
	perlin_zoom = 65
	...
	biome_table = list(
		BIOME_COLDEST = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle_wasteland,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/jungle_wasteland,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/jungle/plains,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/jungle/plains,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/mudlands
		),
		BIOME_COLD = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle_wasteland,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/jungle/plains,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/jungle,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/mudlands,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/mudlands
		),
		BIOME_WARM = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/jungle,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/mudlands,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/mudlands,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/jungle
		),
		BIOME_TEMPERATE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle/dense,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/mudlands,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/jungle/water,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/jungle/water,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/mudlands
		),
		BIOME_HOT = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/jungle,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/jungle/dense,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/jungle/dense,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/jungle/dense
		),
		BIOME_HOTTEST = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/jungle/dense,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/jungle/dense,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/mudlands,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/jungle/water,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/jungle/water
		)
	)

	cave_biome_table = list(
		BIOME_COLDEST_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/jungle,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/jungle,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/jungle,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/jungle,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/jungle
		),
		BIOME_COLD_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/jungle/dirt,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/jungle/dirt,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/jungle/dirt,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/jungle/dirt,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/jungle/dirt
		),
		...
		BIOME_HOT_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/jungle,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/jungle/dirt,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/lush,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/lush/bright,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/lush/bright
		)
	)

/datum/adv_biome/jungle
...
/datum/adv_biome/cave/jungle/dirt
...
/datum/adv_biome/cave/lush/bright
