/datum/advanced_map_generator/planet_generator/rock
	...
	biome_table = list(
		BIOME_COLDEST = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/rock,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/rock,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/rock/icecap,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/rock/icecap
		),
		BIOME_COLD = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/rock,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/rock,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/rock/icecap
		),
		BIOME_WARM = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/rock,
			...
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/rock/wetlands
		),
		BIOME_TEMPERATE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/rock,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/rock,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/rock/wetlands,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/rock/wetlands
		),
		BIOME_HOT = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/rock,
		...
		BIOME_HOTTEST = list(
			...
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/rock,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/rock
		)
	)

	cave_biome_table = list(
		BIOME_COLDEST_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/rock,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/rock,
			BIOME_MEDIUM_HUMIDITY =/datum/adv_biome/cave/rock,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/rock,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/rock
		),
...
/datum/adv_biome/rock
	open_turf_types = list(/turf/open/misc/asteroid/rockplanet/lit = 1)
...
/datum/adv_biome/rock/icecap
	open_turf_types = list(/turf/open/misc/asteroid/snow/lit/rockplanet = 1, /turf/open/misc/asteroid/snow/lit/rockplanet = 5)
	flora_spawn_chance = 1
	mob_spawn_chance = 2

/datum/adv_biome/rock/wetlands
	open_turf_types = list(/turf/open/misc/asteroid/rockplanet/wet/lit = 1)
	flora_spawn_chance = 5
	mob_spawn_chance = 4
	mob_spawn_list = list(
		/mob/living/simple_animal/hostile/netherworld/asteroid = 30,
...
/datum/adv_biome/cave/rock
	closed_turf_types = list(/turf/closed/mineral/random/asteroid/rockplanet = 1)
	open_turf_types = list(/turf/open/misc/asteroid/rockplanet/cracked = 1)
