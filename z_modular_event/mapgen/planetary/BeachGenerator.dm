/datum/advanced_map_generator/planet_generator/beach
	...
	biome_table = list(
		BIOME_COLDEST = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/ocean/deep,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/ocean,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/beach,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/beach,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/grass
		),
		BIOME_COLD = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/ocean/deep,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/ocean,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/beach,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/grass/dense,
		...
		BIOME_TEMPERATE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/ocean/deep,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/ocean,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/beach/dense,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/beach,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/grass
		),
		BIOME_HOT = list(
	...
	cave_biome_table = list(
		BIOME_COLDEST_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/beach/cove,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/beach/magical,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/beach
		),
		BIOME_COLD_CAVE = list(
			BIOME_LOWEST_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/beach/magical,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/beach/cove
		),
		...
		BIOME_HOT_CAVE = list(
			...
			BIOME_LOW_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_MEDIUM_HUMIDITY = /datum/adv_biome/cave/beach,
			BIOME_HIGH_HUMIDITY = /datum/adv_biome/cave/beach/cove,
			BIOME_HIGHEST_HUMIDITY = /datum/adv_biome/cave/beach
		)
	)

/datum/adv_biome/grass
...
/datum/adv_biome/beach
	open_turf_types = list(/turf/open/misc/asteroid/sand/lit = 1)
...
/datum/adv_biome/beach/dense
	open_turf_types = list(/turf/open/misc/asteroid/sand/dense/lit = 1)
	flora_spawn_list = list(
...
/datum/adv_biome/cave/beach
	open_turf_types = list(/turf/open/misc/asteroid/sand/dense = 1)
...
/datum/adv_biome/cave/beach/cove
	open_turf_types = list(/turf/open/misc/asteroid/sand/dense = 1)
...
/datum/adv_biome/cave/beach/magical
