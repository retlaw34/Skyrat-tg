/datum/advanced_map_generator/single_biome/asteroid
	initial_closed_chance = 55
	smoothing_iterations = 50
	birth_limit = 4

	biome_type = /datum/adv_biome/cave/asteroid
...
/datum/advanced_map_generator/single_biome/asteroid/generate_turfs(list/turf/turfs)
	var/maxx
	var/maxy
	var/minx
	var/miny
...
/datum/advanced_map_generator/single_biome/asteroid/generate_turf(turf/gen_turf, changeturf_flags)
...
/datum/advanced_map_generator/single_biome/asteroid/populate_turf(turf/gen_turf)
	if(isspaceturf(gen_turf))
		return
	return ..()

/datum/adv_biome/cave/asteroid
