/datum/advanced_map_generator/single_biome/wasteplanet
	initial_closed_chance = 45
	smoothing_iterations = 50
	birth_limit = 4
	death_limit = 3

	biome_type = /datum/adv_biome/cave/wasteplanet
	area_type = /area/overmap_encounter/planetoid/wasteplanet

/datum/adv_biome/cave/wasteplanet
	open_turf_types = list(/turf/open/misc/asteroid/wasteplanet = 50,
