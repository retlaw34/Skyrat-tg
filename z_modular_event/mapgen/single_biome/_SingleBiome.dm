/datum/advanced_map_generator/single_biome
	...
	var/datum/adv_biome/biome_type
	/// Stored reference to the biome, 'cause why not.
	var/datum/adv_biome/biome
...
/datum/advanced_map_generator/single_biome/New(...)
...
/datum/advanced_map_generator/single_biome/generate_turf(turf/gen_turf, changeturf_flags)
...
/datum/advanced_map_generator/single_biome/populate_turfs()
...
/datum/advanced_map_generator/single_biome/populate_turf(turf/gen_turf)
