/datum/advanced_map_generator/single_turf
	var/turf/turf_type
	var/area/area_type

	var/area/used_area

/datum/advanced_map_generator/single_turf/New(...)
	used_area = GLOB.areas_by_type[area_type] || new area_type
	return ..()

/datum/advanced_map_generator/single_turf/generate_turf(turf/gen_turf, changeturf_flags)
...
/datum/advanced_map_generator/single_turf/space
