...
/turf/open/misc/asteroid/whitesands/lit
	light_range = 2
	light_power = 0.6
...
/turf/open/misc/asteroid/whitesands/dried/lit
	light_range = 2
	light_power = 0.6
	light_color = COLOR_VERY_LIGHT_GRAY
	baseturfs = /turf/open/misc/asteroid/whitesands/dried/lit

/turf/open/floor/plating/grass/whitesands
	initial_gas_mix = WHITESANDS_ATMOS

/turf/open/misc/asteroid/basalt/whitesands
	initial_gas_mix = WHITESANDS_ATMOS
	planetary_atmos = TRUE
	baseturfs = /turf/open/misc/asteroid/whitesands/dried
...
/turf/open/misc/asteroid/basalt/whitesands/Initialize(mapload, inherited_virtual_z)
	. = ..()
	icon_state = "whitesands_basalt[rand(0,1)]"

/turf/open/misc/asteroid/whitesands/grass
	name = "purple grass"
	...
	baseturfs = /turf/open/misc/asteroid/whitesands
	turf_type = /turf/open/misc/asteroid/whitesands/grass
	initial_gas_mix = WHITESANDS_ATMOS
	planetary_atmos = TRUE
...
/turf/open/misc/asteroid/whitesands/grass/Initialize(mapload, inherited_virtual_z)
	. = ..()
	if(smoothing_flags)
...
/turf/open/misc/asteroid/whitesands/grass/lit
	light_power = 1
	light_range = 2

/turf/open/misc/asteroid/whitesands/grass/dead
	name = "dead grass"
...
/turf/open/misc/asteroid/whitesands/grass/dead/lit
	light_power = 1
	light_range = 2
