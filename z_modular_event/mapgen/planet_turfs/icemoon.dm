/turf/open/misc/asteroid/snow
	...
	baseturfs = /turf/open/misc/asteroid/icerock
	icon_state = "snow"
	icon_plating = "snow"
...
/turf/open/misc/asteroid/snow/Entered(atom/movable/AM)
	. = ..()
...
/turf/open/misc/asteroid/snow/Exited(atom/movable/AM)
	. = ..()
	if(!iscarbon(AM) || (AM.movement_type & (FLYING|VENTCRAWLING|FLOATING|PHASING)))
		return
...
/turf/open/misc/asteroid/snow/update_overlays()
	. = ..()
...
/turf/open/misc/asteroid/snow/setDir(newdir)
	if(dir == newdir)
		return ..()
...
/turf/open/misc/asteroid/snow/ex_act(severity, target)
	. = ..()
	ScrapeAway()

/turf/open/misc/asteroid/snow/lit
	light_range = 2
	light_power = 1
	baseturfs = /turf/open/misc/asteroid/icerock/lit

/turf/open/misc/asteroid/snow/lit/whitesands
	baseturfs = /turf/open/misc/asteroid/whitesands/lit
	initial_gas_mix = WHITESANDS_ATMOS

/turf/open/misc/asteroid/snow/lit/rockplanet
	baseturfs = /turf/open/misc/asteroid/rockplanet/lit
...
/turf/open/misc/asteroid/icerock
	gender = PLURAL
	name = "icy rock"
...
/turf/open/misc/asteroid/iceberg/lit
	light_range = 2
	light_power = 1
